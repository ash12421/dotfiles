...
export default function Navbar() {
    ...
    return (
        <nav className="bg-transparent fixed w-full z-50 top-0 py-1">
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link
            href={href}
            className="text-black/70 hover:bg-black hover:text-black px-3 py-2 rounded-md text-lg font-semibold transition-colors duration-300"
        >
            {children}
        </Link>
    )
