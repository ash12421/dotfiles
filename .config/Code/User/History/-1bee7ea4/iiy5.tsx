    ...
    <section className="relative  overflow-hidden pt-[100px]">
      <div className="container mx-auto px-4 pb-24 relative z-10">
        <div className="max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6 text-white/90">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center md:justify-start md:items-start text-center gap-5">
            <Link
              href="#"
              className="bg-black/80 backdrop-blur-sm text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-black transition duration-300 w-fit"
            >
